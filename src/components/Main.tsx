          ...
          <InterviewWrapper>
            ...
            <div>
              ...
              <Interview>
                ...
                재밌어서 사귀게 되었습니다. "보고 싶다"는 한마디에 왕복 3시간의
                거리를 마다하지 않고 달려오고, 잊을만 하면 꽃다발을 사서
                안겨주는 그의 변치않는 사랑과 배려에 점점 더 확신이 생겼습니다.
                취업과 퇴사, 그리고 대학 재입학까지, 삶의 굴곡을 함께하며 쌓아온
                신뢰와 사랑을 바탕으로 서로 아끼며 행복하게 살아가겠습니다.
              </Interview>
            </div>
          </InterviewWrapper>
          <LikeButton />
